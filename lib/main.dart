...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Expense Calculator 20180801234 - Fikri Saefullah',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: MyHomePage(title: '20180801234 - Fikri Saefullah'),
    );
  }
}
                      ...
                      child: ListTile( onTap: () {
                        Navigator.push(
                          ...
                          title: Text(expenses.items[index].category + ": " +
                              ...
                              " \nPengeluaran tanggal " + expenses.items[index].formattedDate,
        ...
        floatingActionButton: ScopedModelDescendant<ExpenseListModel>(
            builder: (context, child, expenses) {
              return FloatingActionButton( onPressed: () {
                ...
                tooltip: 'Penambahan', child: Icon(Icons.add), );
            }
        )
    );
  }
